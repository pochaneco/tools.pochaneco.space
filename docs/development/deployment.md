...
| 項目 | 値 |
|---|---|
| ホスト | `pochaneco.sakura.ne.jp` |
| ユーザー | `pochaneco` |
| デプロイ先パス | `/home/pochaneco/www/tools.pochaneco.space` |
...
```bash
DEPLOY_HOST=pochaneco.sakura.ne.jp \
DEPLOY_USER=pochaneco \
DEPLOY_PATH='/home/pochaneco/www/tools.pochaneco.space' \
