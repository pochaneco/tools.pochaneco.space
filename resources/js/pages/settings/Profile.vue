            ...
            <div class="flex flex-col space-y-6">
                ...
                <Form v-bind="ProfileController.update.form()" class="space-y-6" v-slot="{ errors, processing, recentlySuccessful }">
                    ...
                    <div class="flex items-center gap-4">
                        <Button :disabled="processing" data-test="update-profile-button">{{ t('settings.profile.save') }}</Button>
                        ...
                        >
                            <p v-show="recentlySuccessful" class="text-sm text-neutral-600">{{ t('settings.profile.saved') }}</p>
                        </Transition>
                    </div>
                </Form>
            </div>
