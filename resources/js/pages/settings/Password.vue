...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head :title="t('settings.password.breadcrumb')" />
            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <div class="flex items-center gap-4">
                        <Button :disabled="processing" data-test="update-password-button">{{ t('settings.password.save') }}</Button>
                        ...
                        >
                            <p v-show="recentlySuccessful" class="text-sm text-neutral-600">{{ t('settings.password.saved') }}</p>
                        </Transition>
                    </div>
                </Form>
            </div>
